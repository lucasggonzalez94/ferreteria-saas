...
>(({ className, children, value, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ...
      value={safeValue}
      className={cn(
        "relative flex w-full cursor-default select-none items-center rounded-xl py-2 pl-8 pr-2.5 text-sm outline-none focus:bg-[hsl(var(--brand-accent-soft))] focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      {...props}
    >
